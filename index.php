  ...
  <main>
    ...
    <section class="properties">
      <div class="container">
        ...
        <a href="#" class="properties__browse separator--dark mt-5">BROWSE ALL</a>
      </div>
    </section>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="card text-center">
                      ...
                      <div class="card-body">
                        <h3 class="card-title">Find your future home</h3>
                  ...
                  <div class="swiper-slide">
                    <div class="card text-center">
                      ...
                      <div class="card-body">
                        <h3 class="card-title">Experience agents</h3>
                  ...
                  <div class="swiper-slide">
                    <div class="card text-center">
                      ...
                      <div class="card-body">
                        <h3 class="card-title">Buy or rent homes</h3>
                  ...
                  <div class="swiper-slide">
                    <div class="card text-center">
                      ...
                      <div class="card-body">
                        <h3 class="card-title">Nice Pictures</h3>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="agents__text text-center">
              <h3 class="agents__name">Alayna Becker</h3>
              <p class="agents__telp"><i class="fas fa-phone"></i> (123) 456-7890</p>
              <div class="agents__social">
                <a href="#" class="fab fa-instagram"></a>
                <a href="#" class="fab fa-facebook-square"></a>
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="agents__text text-center">
              <h3 class="agents__name">Melvin Blackwell</h3>
              <p class="agents__telp"><i class="fas fa-phone"></i> (123) 456-7890</p>
              <div class="agents__social">
                <a href="#" class="fab fa-instagram"></a>
                <a href="#" class="fab fa-facebook-square"></a>
          ...
          <div class="col-sm-6 col-lg-3">
            ...
            <div class="agents__text text-center">
              <h3 class="agents__name">Erika Tillman</h3>
              <p class="agents__telp"><i class="fas fa-phone"></i> (123) 456-7890</p>
              <div class="agents__social">
                <a href="#" class="fab fa-instagram"></a>
                <a href="#" class="fab fa-facebook-square"></a>
